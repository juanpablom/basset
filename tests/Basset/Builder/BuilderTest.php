...
class BuilderTest extends PHPUnit_Framework_TestCase {
    ...
    /**
     * testBuilderChecksForBuildPathAndMakesDirectoryIfItDoesNotExist()
     */
    ...
    public function testBuildingExistingProductionCollectionThrowsBuildNotRequiredException()
    {
        ...
        $assetCollection = new Illuminate\Support\Collection( array($asset) );
        $this->collection->shouldReceive('getAssetsWithoutRaw')->once()->with('stylesheets')->andReturn($assetCollection);
        $asset->shouldReceive('build')->once()->andReturn('body { }');

        $this->collection->shouldReceive('getIdentifier')->twice()->andReturn('foo');
    ...
    /**
     * testBuildingDevelopmentCollectionWithNoCurrentManifestEntry()
     */
    ...
    /**
     * testBuildingDevelopmentCollectionWithNoChangesButWithForcing()
     */
    ...
    /**
     * testBuildingDevelopmentCollectionWithGzip()
     */
